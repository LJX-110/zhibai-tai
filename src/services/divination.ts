/**
 * 奇 —— 占卜基础数据（每日签 + 八卦）
 * 具体起卦算法分置：梅花易数在 meihua.ts、大衍筮法在 dayan.ts
 */
...
export const DAILY_SIGNS: DailySign[] = [
  ...
  { title: '燎原', text: '星火已成势，今日宜顺流推进一步。', tag: '力', do: '顺势推进', dont: '逆势强求', advice: '风口上的事，顺水推舟。' },
  ...
  { title: '开闸', text: '水满则涨，今日宜开闸疏泄，说与可信之人。', tag: '宣', do: '倾诉表达', dont: '憋在心里', advice: '闸开了，水就不涨了。' },
